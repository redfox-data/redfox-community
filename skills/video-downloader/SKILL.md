...
通过 [redfox.hk](https://www.redfox.hk) API 解析并下载主流短视频平台的无水印视频/图文。
...
内置了公共 API Key（约 10000 次免费额度），开箱即用，无需任何配置。

### 后续使用

超出后，可访问：https://redfox.hk/login 注册即可获取免费Token
...
**Q：公共 Key 有多少次免费额度？**
A：约 10000 次。超出后 API 返回 3107 错误，请配置自己的 Key。

**Q：如何获取自己的 API Key？**
A：前往 [redfox.hk](https://www.redfox.hk/login) 注册即可获取免费 Token。
