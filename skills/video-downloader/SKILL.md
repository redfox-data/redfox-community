...
- **去水印**：API 自动返回无水印直链
- **开箱即用**：内置公共 API Key，约 10000 次免费额度，无需任何配置
...
内置公共 API Key（约 10000 次免费额度），开箱即用，无需任何配置。

### 后续使用

超出免费额度后，可访问 [redfox.hk](https://redfox.hk/settings/api-keys?source=github) 注册获取个人 API Key。
