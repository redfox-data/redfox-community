...
- **📈 智能趋势分析**：自动分析TOP50数据的涨粉趋势，量化热点事件对涨粉的拉动效果
- **🔔 定时订阅推送**：一键订阅日榜/周榜/月榜，更新时间自动送达

### ✨ 特色亮点

- **⚡ 实时更新**：日榜每日18:00更新、周榜每周一18:00更新、月榜每月3号18:00更新
- **🏆 可视化呈现**：TOP3金银铜牌标识，榜单含账号头像与可点击跳转链接
- **📱 深度洞察**：基于全量TOP50数据的两段式分析（涨粉趋势 + 热点影响力量化）
...
> 用户：查一下美食类的抖音涨粉榜
>
> 助手：自动匹配"美食"分类，输出日榜TOP20排行 + 涨粉趋势分析 + 订阅提示
