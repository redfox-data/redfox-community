...
> - 用完额度后可前往 [红狐hub](https://redfox.hk/settings/api-keys?source=github) 注册获取免费 Token 继续使用
...
公共 Key 额度用完后，前往 [红狐hub](https://redfox.hk/settings/api-keys?source=github) 注册账号获取自己的 API Token，三种配置方式任选其一：
...
**Q：额度用完了怎么办？**
A：前往 [红狐hub](https://redfox.hk/settings/api-keys?source=github) 注册获取自己的 API Token。
