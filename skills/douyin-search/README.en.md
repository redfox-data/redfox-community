...
- **Structured table display**: Shows the top 20 results by default, including clickable work titles, author, likes, comments, shares, and saves. Numbers above 10,000 are auto-formatted as "x.xw" for quick readability.
...
| #   | Work Title                                       | Author         | Likes  | Comments | Shares | Saves |
| --- | ------------------------------------------------ | -------------- | ------ | -------- | ------ | ----- |
| 1   | [Let me show you how to make this dish…](link)   | FoodieA        | 305.2w | 7.1w     | 51.0w  | 14.7w |
| 2   | [Travel vlog: A spontaneous weekend trip…](link) | TravelBloggerB | 158.3w | 3.2w     | 22.1w  | 8.5w  |
